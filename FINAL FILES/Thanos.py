...
#Recursively deletes half of the files of every directory in the D:\ Drive
...
#Loads and initializes variables needed to map thanos' face
try:
...
#For each face detected in image.jpg, thanos's face will be mapped onto it
